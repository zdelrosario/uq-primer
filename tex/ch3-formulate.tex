...
connected to the summaries introduced above. Generally, moments are quantities
of the form $\E[X^k]$. Familiar moments include the mean $\mu$ and variance
$\sigma^2$, defined
...
\emph{standard}, and is often denoted $Z \sim N(0, 1)$.
...
\begin{equation} \label{eq:mean-clt}
  \frac{1}{n}\sum_{i=1}^n X_i \stackrel{d}{\to} N(\E[X], \V[X]/n),
\end{equation}

\noindent where $\stackrel{d}{\to}$ denotes a particular (weak) form of
convergence.
...
\begin{figure*}[!ht]
  ...
  \caption{Common densities and their first two moments.}
