...
\noindent where we use the same averaging trick as above for non-integer values.
The mean was susceptible to outliers; since the variance is essentially a mean
of squared-differences, the standard deviation is similarly vulnerable to
outliers.
