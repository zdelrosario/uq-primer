...
which take some deterministic input $\vx \in \R{m}$, and return a single,
deterministic, scalar output $y \in \R{}$, with the functional relation
...
answer to this question requires choosing a context and propagating the
...
illustrate the difference and need for these two separate approaches.
...
\textbf{Local sensitivity analysis} usually refers to computing derivatives
of an output quantity $y$ with respect to the inputs $\vx$.

\textbf{Global sensitivity analysis}
